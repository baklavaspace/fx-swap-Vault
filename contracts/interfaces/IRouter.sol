...
interface IRouter {
    ...
    function removeLiquidityFX(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountToken, uint256 amountFX);
    ...
    function removeLiquidityFXSupportingFeeOnTransferTokens(
        ...
        address to,
        uint256 deadline
    ) external returns (uint256 amountFX);
